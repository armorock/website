...
const LandingPageSection3: NextPage<LandingPageSection3Type> = ({
  ...
  return (
    ...
    >
      <h2 className="m-0 relative text-5xl leading-[80px] uppercase font-medium font-[inherit] mq450:text-3xl mq450:leading-[48px] mq825:text-4xl mq825:leading-[64px]">
