...
const DifferenceSection: NextPage<DifferenceSectionType> = ({
  ...
  return (
    ...
    <main
      className={`self-stretch overflow-hidden shrink-0 flex flex-col items-center justify-start py-16 px-[87px] box-border gap-[38px] bg-[url('/difference-section@3x.png')] bg-cover bg-no-repeat bg-[top] max-w-full mq450:pl-5 mq450:pr-5 mq450:box-border mq675:gap-[19px] mq675:py-[27px] mq675:px-[43px] mq675:box-border mq825:pt-[42px] mq825:pb-[42px] mq825:box-border ${className}`}
    >
      <section className="w-[663px] h-[213px] flex flex-col items-start justify-start max-w-full text-center text-6xl font-oswald">
      ...
      <div className="self-stretch flex flex-row items-start justify-start flex-wrap content-start gap-12 mq675:gap-6">
