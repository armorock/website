...
const CTASection: NextPage<CTASectionType> = ({ className = "" }) => {
  ...
  return (
    <section
      className={`self-stretch bg-gray-100 overflow-hidden flex flex-col items-center justify-start py-16 px-6 md:px-[80px] lg:px-[118px] gap-[15px] text-center text-[22px] text-white font-open-sans mq675:pt-[42px] mq675:pb-[42px] mq675:box-border ${className}`}
    >
      <Image
        ...
        src="/logo3@2x.png"
      />
      <h3 className="m-0 self-stretch relative text-[length:inherit] leading-[35px] font-normal font-[inherit] inline-block mq825:text-xl mq825:leading-8 mq450:text-lg mq450:leading-7 max-w-4xl mx-auto">
      ...
      <div className="flex flex-row items-center justify-center pt-8 px-0 pb-0 box-border gap-[38px] mq675:gap-[25px] mq450:gap-4 mq450:flex-wrap mq450:pt-6">
        <button
