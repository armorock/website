      ...
      <section className="self-stretch h-[515px] overflow-hidden shrink-0 flex flex-col items-start justify-start py-0 px-[25px] box-border sticky gap-2 bg-[url('/hero-section2@3x.png')] bg-cover bg-no-repeat bg-[top] top-[0] z-[99] text-left text-6xl text-gray-100 font-oswald">
        <section className="self-stretch flex flex-row items-start justify-between py-[15px] px-0 z-[0] text-left text-[40px] text-gray-100 font-oswald">
          <div className="flex-1 flex flex-row items-center justify-between flex-wrap content-center gap-x-0 gap-y-5">
            ...
            <nav className="m-0 flex-1 flex flex-row items-center justify-end flex-wrap content-center gap-[42px] text-right text-xl text-black font-oswald mq675:gap-[21px]">
              <h3
        ...
        <div className="w-[1319px] h-[365px] !!m-[0 important] absolute top-[118px] left-[53px] flex flex-row items-start justify-start pt-0 px-0 pb-[265px] box-border z-[1]">
          <h1 className="m-0 w-[1266px] relative text-[length:inherit] leading-[100px] uppercase font-medium font-[inherit] inline-block shrink-0 z-[0]">
            Life cycle Cost analysis
          </h1>
          <h1 className="!!m-[0 important] w-[755px] absolute right-[0px] bottom-[0px] text-[length:inherit] leading-[75px] uppercase font-medium font-[inherit] text-right flex items-center z-[1]">
