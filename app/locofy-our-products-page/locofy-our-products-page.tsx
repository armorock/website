...
const LocofyOurProductsPage: NextPage = () => {
  ...
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-center justify-start gap-[3px] leading-[normal] tracking-[normal]">
      ...
      <OurProductsSection />
      <section className="self-stretch overflow-hidden flex flex-col items-end justify-start py-12 px-[15px] text-center text-[22px] text-gray-100 font-open-sans mq450:pt-8 mq450:pb-8 mq450:box-border">
        <div className="self-stretch flex flex-row items-center justify-center flex-wrap content-start pt-0 px-0 pb-0.5 box-border gap-16 max-w-full md:gap-8 sm:gap-6 xs:gap-4 md:flex-col md:items-center">
          <div className="flex flex-col items-center justify-start gap-[38px] w-full max-w-[420px] md:max-w-[300px] sm:max-w-[200px] xs:max-w-[140px] md:gap-5 sm:gap-4">
          ...
          <section className="flex flex-col items-center justify-center gap-[15px] w-full max-w-[600px] md:max-w-[500px] sm:max-w-[350px] xs:max-w-[250px] text-left text-[22px] text-gray-100 font-open-sans">
